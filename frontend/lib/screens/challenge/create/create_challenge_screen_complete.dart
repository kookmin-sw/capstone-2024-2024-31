...
class CreateCompleteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        canPop: false, //챌린지 생성 후 뒤로가기 못하게
        onPopInvoked: (didPop) {
          Get.to(() => const MainScreen(tabNumber: 0)); //챌린지 생성 후 back 버튼시 홈화면으로
        },
        child: Scaffold(
            body: Column(
          ...
          children: [
            ...
            GestureDetector(
                onTap: () {
                  ChallengeService.fetchChallenge(challengeId)
                      .then((challenge) {
                ...
                child: Container(
                    ...
                    child: Text("챌린지 자세히 보기",
                        style: buttonTextStyle(Palette.white)))),
