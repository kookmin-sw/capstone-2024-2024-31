...
class _PieChartState extends State<PieChart>
  ...
  void initValues() {
    legendValues = widget.dataMap.values.toList(growable: false).cast<double>();
  }
      ...
      return Padding(
        ...
        child: Wrap(
          ...
          children: legendTitles!
              .asMap()
              .map((index, item) {
            final value = widget.dataMap[item]; // 수정된 부분
            return MapEntry(
              index,
              Legend(
                index: index,
                ...
                valueStyle:  widget.legendOptions.legendValueTextStyle,
